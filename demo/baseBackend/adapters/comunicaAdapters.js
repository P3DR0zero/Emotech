  ...
  connect() {
    ...
    this.client.on('message', (topic, message) => {
      try {
        ...
        if (this.twinState && typeof this.twinState.updateSensorState === 'function') {
          this.twinState.updateSensorState(data);
        }
